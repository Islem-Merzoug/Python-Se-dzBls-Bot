...
class Bot:
    def configure_bot(self, ip):
        ...
        categorie = driver.find_element_by_id('category')
        categorie.send_keys('Normal')
        ...
        WebDriverWait(driver, 500).until(EC.element_to_be_clickable(
            (By.XPATH, '/html/body/div/div/div[3]/div/div[1]/div[5]/div')))

        allsms = driver.find_element_by_xpath('/html/body/div/div/div[3]/div/div[1]/div[5]/div')
        allsms.click()
        print('10')
    ...
    def refresh(self, bot):
        try:
            for ip in IP:
                bot.configure_bot(ip)

            element = WebDriverWait(bot, 3).until(
                EC.presence_of_element_located((By.CLASS_NAME, 'juridition'))
            )
...
# # driver.get('http://algeria.blsspainvisa.com/book_appointment.php')  # open webpage
#
# IP = ["64.225.62.241:3128","12.345.678.910:8080"]
#
# class Driver:
...
#
#         WebDriverWait(driver, 500).until(EC.element_to_be_clickable(
#             (By.XPATH, '/html/body/div/div/div[3]/div/div[2]/div[1]/div[6]')))
#
#         sms = driver.find_element_by_xpath('/html/body/div/div/div[3]/div/div[2]/div[1]/div[6]')
#         sms.click()
#         print('11')
#
#         # WebDriverWait(driver, 180).until(EC.element_to_be_clickable(
